...
export type GetCustomerProjectsQuery = { __typename?: 'Query', getCustomerProjects: Array<{ __typename?: 'CustomerProjectOverview', id: string, userId: string, name: string, deliveryDate: string, deliveryAddress: string, targetPrice: string, orderQuantities: Array<number>, status: string, permission: Types.ProjectPermission, visibility: Types.ProjectVisibility, totalWeight: string, category: string, createdAt: any, updatedAt: any }> };
