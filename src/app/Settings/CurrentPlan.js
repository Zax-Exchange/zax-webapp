...
const TitleTypography = styled((props) => <Typography {...props} variant="subtitle2"/>)()
const DetailTypography = styled((props) => <Typography {...props} variant="caption"/>)()
  ...
  return <Container>
    ...
    <List>
      ...
      <ListItem>
        ...
        <DetailTypography>${price} / {billingFrequency}</DetailTypography>
      </ListItem>

      <ListItem>
        <TitleTypography>Total licensed users</TitleTypography>
        <DetailTypography>{licensedUsers}</DetailTypography>
      </ListItem>

      <ListItem>
        <TitleTypography>Remaining quota</TitleTypography>
        <DetailTypography>{remainingQuota}</DetailTypography>
      </ListItem>
